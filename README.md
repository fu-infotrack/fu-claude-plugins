...
| herdr-tabs | hooks + command + scripts | Keep a Herdr tab's label in sync with the Claude session title (SessionStart/Stop hooks; `/herdr-tabs start` for a background watcher covering panes and agents that fire no Claude hook) |
